...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| LLM-E1 | LLMeeting MVP 收尾 | Epic |  | P1 | Review | Codex |  | 完成實機驗收與 review | 自動測試、語法檢查、Chrome 實機試跑 | 12 | chrome-extension, ai-debate | 0.2.2 已完成程式碼實作 |
| LLM-T1 | 多 AI 辯論基礎流程 | Task | LLM-E1 | P1 | Done | Codex |  | 無 | 使用 ChatGPT/Gemini/Grok 實際試跑，主人回報可運行 | 2 | mvp | 已完成 |
| LLM-T2 | Claude 參與者支援 | Task | LLM-E1 | P2 | Ready | Codex | LLM-T7 | reload 後讓 Claude 參與一輪快速辯論 | Chrome 實機跑 Claude input/send/response selector | 2 | provider, claude | 已預設勾選，仍需實機驗證 |
...
| LLM-T7 | Chrome 實機驗收 | Task | LLM-E1 | P1 | Ready | 主人 | LLM-T3, LLM-T4 | reload extension 後測快速辯論與總結辯論 | Chrome 實際分頁中跑 ChatGPT/Gemini/Grok/Claude | 2 | manual-smoke | 需要主人目前登入狀態 |
