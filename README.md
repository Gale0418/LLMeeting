...
5. Pro 入口已預留：快速鬪技場與總結辯論目前會顯示鎖定提示，之後接授權後解鎖。
6. 每場真實辯論會為各 provider 開啟新的對話分頁，再於同一分頁延續互評。
7. 等待新回覆時會排除剛送出的主人提問泡泡，避免誤判為 AI 回答。

## Free / Pro 分層

- Free：四家 AI 基礎輪流辯論、provider 勾選、裁判選擇、transcript 與診斷資訊。
- Pro 預留：快速鬪技場、總結目前對話後開始辯論、匯出、歷史紀錄。
...
2. 加入 Grok，再跑一場三方辯論。
3. 加入 Claude，跑一場四方辯論。
4. 點快速鬪技場與總結辯論，確認 Free 版只顯示 Pro 鎖定提示。
