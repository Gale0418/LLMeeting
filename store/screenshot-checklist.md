...
- Use a clean Chrome profile or hide personal chat history.
- Use short harmless prompts such as `天為什麼是藍的？`.
- Avoid exposing private account names, emails, or paid-plan information.
